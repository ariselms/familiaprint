			...
			<div className="py-16 px-4 mx-auto max-w-screen-xl text-center lg:py-32">
				<h1 className="mb-12 text-4xl md:text-5xl font-extrabold tracking-tight leading-none text-gray-900 lg:text-6xl dark:text-white">
					{language === languageOptions.english
						? "Welcome to Familia Print"
						: "Bienvenido a Familia Print"}
				</h1>
				<p className="mb-16 text-lg font-normal text-gray-700 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-300">
					{language === languageOptions.english
						? "Offering visual solutions for ads, signs, websites and much more. Discover our all-in-one platform, made in Puerto Rico. We have your solution tailor made for your business needs."
						: "Ofrecemos soluciones visuales de anuncios, letreros, websites y mucho más. Descubre nuestra plataforma todo en uno, hecho en Puerto Rico. Tenemos la solución medida a tus necidades de negocio."}
				</p>
