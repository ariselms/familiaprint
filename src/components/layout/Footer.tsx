			...
			<div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
				...
				{/* <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
					<div>
						<h3 className="text-sm/6 font-semibold text-white">
							{language === languageOptions.spanish
                ? "Suscríbete a nuestros anuncios y ofertas"
              ...
              {language === languageOptions.spanish
                ...
                : "Email"
						...
						<input
							...
							type="email"
							required
							placeholder={language === languageOptions.spanish
                ? "Correo"
                : "Email"
              }
							autoComplete="email"
						...
						<div className="mt-4 sm:ml-4 sm:mt-0 sm:shrink-0">
							<button
								type="submit"
								className="px-4 py-2 rounded-xl font-bold text-blue-100 cursor-pointer bg-blue-950 hover:bg-blue-900 transition-all">
								{language === languageOptions.spanish
                  ? "Suscribirse"
                  : "Subscribe"
                }
