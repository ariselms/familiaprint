...
const MainHeader = () => {
	...
	return (
			<header className="relative rounded-xl bg-gradient-to-b from-blue-200/10 to-sky-200/40 border border-blue-200 backdrop-blur-md border-2 relative w-full z-10">
				<nav>
					<div className="flex justify-between items-start px-4 pb-4 pt-8">
						<Link
							...
							<span className="text-4xl text-marinedark">
								&nbsp; {languageContext.language === "en" ? "by" : "por"}{" "}
								Leónidas
							</span>
						</Link>
