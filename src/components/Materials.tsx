...
const ServicesMaterialsCard = ({ material }: { material: MaterialsType }) => {
	...
	return (
		<div className="h-auto max-w-full rounded-lg">
			<div className="p-8 md:p-12 h-full bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 flex flex-col">
				{/* <svg
				...
				<div className="flex-col mt-auto">
					...
					<Link
						...
						className="flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-black hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 dark:bg-white dark:text-black dark:hover:bg-gray-200  dark:focus:ring-gray-900 transition-all lg:inline-flex xl:ms-3">
						<svg
