...
export default async function Home() {
  ...
  return (
        ...
        propsData={{
          ...
          spDescription: "Ofrecemos soluciones visuales de anuncios, letreros, websites y mucho más. Descubre nuestra plataforma todo en uno, hecho en Puerto Rico. Tenemos la solución medida a tus necidades de negocio.",
          hasButtons: true,
